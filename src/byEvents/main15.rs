...
use crate::envs::env::*;
use crate::structs::events::Event15;

// Constants
const EVENT_CODE: &str = "15";
...
fn parse_output(data: &serde_json::Value) -> Vec<Event15> {
...
fn write_to_csv(entries: Vec<Event15>, filename: &str) -> std::io::Result<()> {
    ...
    match fetch_data_from_es().await {
        Ok(data) => {
            ...
            if let Err(e) = write_to_csv(
                entries,
                "C:/Users/samsung/Downloads/csvfiles/event15_filestream_joe_pc_20230808_1200.csv",
            ) {
                // if let Err(e) = write_to_csv(entries, "/Users/dong-ju/Dropbox/EINSIS/03. CODE/files/event15_filestream_joe_pc_20230808_1200.csv") {
