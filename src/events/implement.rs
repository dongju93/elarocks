use super::{
    Event1, Event10, Event11, Event12, Event13, Event14, Event15, Event17, Event18, Event2,
    Event22, Event23, Event25, Event26, Event3, Event5, Event7, Event9,
};
use std::{fs, io};
...
pub(crate) trait EventToCSV: Sized {
    ...
    fn write_to_csv(entries: &[Self], filename: &str) -> std::io::Result<()>;
}
...
impl EventToCSV for Event1 {
    ...
    fn write_to_csv(entries: &[Self], filename: &str) -> io::Result<()> {
